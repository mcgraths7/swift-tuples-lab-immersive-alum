...
var person: (name: String, age: Int) = ("Joe", 23)
...
var someone: (name: String, age: Int) = ("Steven", 28)
...
print("Happy Birthday \(someone.name)!")
...
let human: (name: String, age: Int) = ("Human", 11)
 ...
 */
// No, human was defined as a constant
